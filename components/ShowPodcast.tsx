...
function ShowPodcast() {
  ...
  return (
    <div className="relative z-10 mx-auto px-4 pb-4 pt-10 sm:px-6 md:max-w-2xl md:px-4 lg:min-h-full lg:flex-auto lg:border-x lg:border-slate-200 dark:lg:border-slate-700 lg:px-8 lg:py-12 xl:px-12">
      <a
        className="relative mx-auto block w-48 overflow-hidden rounded-lg bg-slate-200/25 dark:bg-slate-800/25 shadow-xl shadow-slate-200 dark:shadow-slate-800 sm:w-64 sm:rounded-xl lg:w-auto lg:rounded-2xl"
        aria-label="Homepage"
        href="/"
      >
        <Image
          src="/images/host-02.png"
          alt="Podcast"
          width={960}
          height={960}
          decoding="async"
      ...
      <div className="mt-10 text-center lg:mt-12 lg:text-left">
        ...
        <p className="mt-3 text-lg font-medium leading-8 text-slate-700 dark:text-slate-300">
      ...
      <section className="mt-12 hidden lg:block">
        ...
        <p className="mt-2 text-base leading-7 text-slate-700 dark:text-slate-300 lg:line-clamp-4">
        ...
        <button
          type="button"
          className="mt-2 hidden text-sm font-bold leading-6 text-pink-500 hover:text-pink-700 dark:text-pink-300 active:text-pink-900 lg:inline-block"
        >
          Show more
        </button>
      </section>
      <section className="mt-10 lg:mt-12">
        <h2 className="sr-only flex items-center font-mono text-sm font-medium leading-7 text-slate-900 text-primary dark:text-slate-100 lg:not-sr-only">
          <svg aria-hidden="true" viewBox="0 0 10 10" className="h-2.5 w-2.5">
            <path
              d="M0 5a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v4a1 1 0 0 1-1 1H1a1 1 0 0 1-1-1V5Z"
          ...
          <li className="flex">
            ...
            >
              <svg
                aria-hidden="true"
                viewBox="0 0 32 32"
                className="h-8 w-8 fill-slate-400 group-hover:fill-slate-600 dark:group-hover:fill-slate-200"
              >
              ...
              <span className="hidden sm:ml-3 sm:block dark:text-slate-400">
                Spotify
              </span>
            </a>
          </li>
